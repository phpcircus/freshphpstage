<template>
    <layout title="About Me">
        ...
        <p class="text-xl md:text-2xl text-blue-800 font-normal mb-4 leading-normal tracking-normal">
            It wasn't until about 10 years later that my interest was piqued again. This time with Ruby on Rails. I dabbled for a while and eventually discovered Laravel. I dove head first into Laravel, and I've learned a lot over the past couple of years. Now, I find myself backtracking and learning the fundamentals of web development and PHP, which I missed trying to find a shortcut to success in programming.
        </p>
        <p class="text-xl md:text-2xl text-blue-800 font-normal mb-4 leading-normal tracking-normal">

<template>
    <layout title="Create Post">
        ...
        <div class="bg-white rounded shadow overflow-hidden w-full">
            <form class="w-full md:w-3/4" @submit.prevent="submit">
                <div class="p-8 -mb-8 flex flex-col">
                    <text-input v-model="form.title" :errors="errors.title" class="pb-8 w-full lg:w-1/2" label="Post Title" />
                    <textarea-input v-model="form.summary" :errors="errors.summary" class="pb-8 w-full lg:w-1/2" rows="2" label="Post Summary" />

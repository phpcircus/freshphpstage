<template>
    <div class="flex flex-col">
        <div class="flex">
            <input v-model="query" class="w-260p md:w-300p border-2 border-blue-500 px-2 py-1 md:py-2 rounded -mt-1" placeholder="Search posts…" type="text" @input="performSearch">
        </div>
